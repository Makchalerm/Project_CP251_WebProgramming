...
<body>
    ...
    <div class="w3-container w3-center" style="padding:128px 16px">
        <form action="delete_p.php" method="POST" class="w3-container">
    ...
    $detail_ID = $_GET['regID'];
    $delete_id = "DELETE FROM register WHERE regID = $detail_ID";
