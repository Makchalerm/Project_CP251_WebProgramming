...
<head>
    ...
    <title>Security Agency for employer</title>
    <!--Favicons-->
...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-white w3-card" id="myNavbar">
            <a href="employer_index.php" class="w3-bar-item w3-button w3-wide">SA</a>
    ...
    <header class="bgimg-1 w3-display-container w3-black" id="home">
        <div class="w3-display-left w3-text-white" style="padding:48px">
            <span class="w3-jumbo w3-hide-small">Security Agency for employer</span><br>
            <span class="w3-xxlarge w3-hide-large w3-hide-medium">Security Agency for employer</span><br>
            <span class="w3-large"><i class="fa fa-search"></i> Find a wage your security do you want.</span><br>
            <p></p>
            <?php
            include '../login/server.php';
            $search = $_GET['search'] ?? null;
            ?>
            <form action="../find/find_a_person.php">
                <input class="w3-input w3-animate-input w3-black " type="text" name="search" id="search" placeholder="Search for wage.." style="width: 30%;">

            </form><br>
            <hr>

            <div class="w3-col  w3-white"><a href="../find/find_a_person.php" class="w3-button w3--left w3-xlarge w3-round " style="width:100%"> Find people </a>
            </div>
        </div>
        </div>
    </header>
